...
class Master(models.Model):
    ...
    class Meta:        
        constraints = [
            models.UniqueConstraint(fields=['name', 'user'], name='User can only have one master with this name'),
            models.UniqueConstraint(fields=['slug', 'user'], name='Slug for master - unique')
        ]  
...
class List(models.Model):
    ...
    class Meta:        
        constraints = [
            models.UniqueConstraint(fields=['name', 'user'], name='User can only have one list with this name'),
            models.UniqueConstraint(fields=['slug', 'user'], name='Slug for list - unique')
        ]  
...
class Author(models.Model):
    ...
    class Meta:        
        constraints = [
            models.UniqueConstraint(fields=['name', 'user'], name='User can only create one author with this name'),
        ] 
...
class Book(models.Model):
    ...
    class Meta:        
        constraints = [
            models.UniqueConstraint(fields=['title', 'user'], name='User can only create one book with this title'),
        ]  
...
class Book_In_List(models.Model):
    ...
    class Meta:        
        constraints = [
            models.UniqueConstraint(fields=['book', 'list'], name='book once in a list')
        ]  
...
class Author_In_List(models.Model):  
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['author', 'list'], name='author once in a list')
        ]   
...
class Book_In_Master(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['book', 'master'], name='book once in master')
        ]
...
class Author_In_Master(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['author', 'master'], name='author once in a master')
        ]
